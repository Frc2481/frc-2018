...
public:
	...
	static constexpr double k_flRadiusPercent = 1.0; //0.98;
	static constexpr double k_frRadiusPercent = 1.0; //0.98;
	static constexpr double k_blRadiusPercent = 1.0; //0.98;
	static constexpr double k_brRadiusPercent = 1.0; //0.98;
