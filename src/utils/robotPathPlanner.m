...
% waypoints = [83, 280, 0, 0;
%              83, 244, 0, 10;
%              91, 244, 0, 10;
%              91, 240, 0, 0];
         
% left cube 1 to left scale
csvFilename = 'PathLeftCube1ToLeftScale.csv';
waypoints = [91, 240, 0, 0;
             91, 244, 0, 10;
             83, 244, 0, 10;
             83, 280, 0, 0];
...
%              fieldDimensions(1) - 83, 280, 0, 0];

% right scale to right cube 1
% csvFilename = 'PathRightScaleToRightCube1.csv';
% waypoints = [fieldDimensions(1) - 83, 280, 0, 0;
%              fieldDimensions(1) - 91, 240, 0, 1000;
%              0, 0, 0, 0];
