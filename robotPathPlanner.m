...
cubeGrabDist = 18;
cubeSpacing = 28.1;
scaleApproachDist = 247;
cubeApproachDist = 247;
platformAlley = 247;
maxSpeed = 90; % 90
maxAccel = 100; % 100
maxSpeed2 = 105; % 105
...
leftScale = [71.57 + 3, 288 - (robotDim(2) / 2) + 6, -20, 0];
leftScaleWP2 = [71.57 + 3, scaleApproachDist, 0, 20];
leftCube1Approach = [85.25 + (cubeDim / 2) + 2, cubeApproachDist, 0, 5];
leftCube1 = [85.25 + (cubeDim / 2) + 2, 196 + (cubeDim / 2) + (robotDim(2) / 2) + cubeGrabDist, 0, 0];
leftCube2Approach = [85.25 + (cubeDim / 2) + cubeSpacing, cubeApproachDist, 0, 5];
leftCube2 = [85.25 + (cubeDim / 2) + cubeSpacing, 196 + (cubeDim / 2) + (robotDim(2) / 2) + cubeGrabDist, 0, 0];
leftCube3Approach = [85.25 + (cubeDim / 2) + 2 * cubeSpacing, cubeApproachDist, 0, 5];
...
% rightScaleWP2 = [fieldDim(1) - 71.57 - 3, platformAlley, 0, 20];
% rightScale = [fieldDim(1) - 71.57 - 3, 288 - (robotDim(2) / 2) + 4, 20, 0];
% rightScaleWP3 = [fieldDim(1) - 71.57 - 3, scaleApproachDist, 0, 20];
